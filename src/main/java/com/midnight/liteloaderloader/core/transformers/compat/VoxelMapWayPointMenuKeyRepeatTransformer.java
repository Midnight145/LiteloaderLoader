...
public class VoxelMapWayPointMenuKeyRepeatTransformer extends ClassTransformer {

    private static final long cushionTime = 500_000L;
    private static long enterTime = 0L;
    private static boolean enterTrigger = false;

    public VoxelMapWayPointMenuKeyRepeatTransformer() {
        super();
    ...
    private void m(MethodNode methodNode) {
        ...
        /*
         * com.midnight.liteloaderloader.core.transformers.compat.VoxelMapWayPointMenuKeyRepeatTransformer.closeBefore()
         */
        {
            insert.add(
                new MethodInsnNode(
                    Opcodes.INVOKESTATIC,
                    "com/midnight/liteloaderloader/core/transformers/compat/VoxelMapWayPointMenuKeyRepeatTransformer",
                    "closeBefore",
                    "()V",
                    false));
        }
    ...
    private void a(MethodNode method) {
        if ((method.access & Opcodes.ACC_PROTECTED) != 0 && (method.access & Opcodes.ACC_FINAL) != 0
            ...
            InsnList insert = new InsnList();
            /*
             * if (!com.midnight.liteloaderloader.core.transformers.compat.VoxelMapWayPointMenuKeyRepeatTransformer.
             * inputBefore()) {
             * return;
             * }
             */
